...
// falling back to the browser's language. Seeding the preference once (only
// when unset) makes the editor follow the site's language on first load; the
// owner can still change it later in Settings, which we then respect.
